...
public class RecycleView_Select extends RecyclerView.Adapter<RecycleView_Select.ViewHolder> {
    ...
    public RecycleView_Select(List<tagModel> tagModelList, Click click) {
        this.tagModelList = tagModelList;
        this.click = click;
    }

    public interface Click{
        void click_item_select(tagModel tagModel);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.item_tagview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (click!=null)click.click_item_select(tagModel);
            }
        });
    }
